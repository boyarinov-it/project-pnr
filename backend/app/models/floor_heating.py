...
class FloorHeating(Base):
    __tablename__ = "floor_heating"
    ...
    thermostat_type: Mapped[str] = mapped_column(String(100), nullable=False)
    ...
    project = relationship("Project", back_populates="floor_heating")
