...
class Climate(Base):
    ...
    # AC / RADIATOR / CONVECTOR / FANCOIL / VENTILATION
    ...
    # На будущее для Modbus/шлюзов/вентиляции/кондиционеров.
    gateway_address: Mapped[str | None] = mapped_column(String(100), nullable=True)
    external_id: Mapped[str | None] = mapped_column(String(100), nullable=True)

    room = relationship("Room")
    project = relationship("Project", back_populates="climate")
